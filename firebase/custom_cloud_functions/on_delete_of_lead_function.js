...
exports.onDeleteOfLeadFunction = functions.firestore
  ...
  .onDelete(async (snap, context) => {
    ...
    try {
      const componentContentQuerySnapshot = await admin
        .firestore()
      ...
      console.log(
        `Deleted ${componentContentQuerySnapshot.size} component contents for lead ${leadId}`,
      );
    } catch (error) {
