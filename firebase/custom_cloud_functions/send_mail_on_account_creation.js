...
sgMail.setApiKey('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');
// To avoid deployment errors, do not call admin.initializeApp() in your code

exports.sendMailOnAccountCreation = functions.auth.user().onCreate(async (user) => {
