...
class _LoginregisterWidgetState extends State<LoginregisterWidget>
  ...
  void initState() {
    ...
    _model.regEmailController ??= TextEditingController();
    _model.regEmailFocusNode ??= FocusNode();

    _model.regPassController ??= TextEditingController();
    _model.regPassFocusNode ??= FocusNode();

    _model.regConfirmPassController ??= TextEditingController();
    _model.regConfirmPassFocusNode ??= FocusNode();
                                                                  ...
                                                                  suffixIcon:
                                                                    ...
                                                                    focusNode: FocusNode(
                                                                        skipTraversal:
                                                                            true),
                                                                    child: Icon(
                                                                      _model.regConfirmPassVisibility
                                                                          ? Icons
                                                                              .visibility_outlined
                                                                          : Icons
                                                                              .visibility_off_outlined,
