...
class TTSDetailsAndEditWidget extends StatefulWidget {
  const TTSDetailsAndEditWidget({
    super.key,
    required this.headText,
    required this.ttsDoc,
  });
  ...
  State<TTSDetailsAndEditWidget> createState() =>
      _TTSDetailsAndEditWidgetState();
}

class _TTSDetailsAndEditWidgetState extends State<TTSDetailsAndEditWidget> {
  late TTSDetailsAndEditModel _model;
