...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          ...
          path: '/leadDetailView',
          asyncParams: {
            'leadDoc': getDoc(['leads'], LeadsRecord.fromSnapshot),
          },
          builder: (context, params) => LeadDetailViewWidget(
        ...
        FFRoute(
          ...
          path: '/speechToTextNotesPage',
          builder: (context, params) => SpeechToTextNotesPageWidget(
