...
class ComponentMarketplaceListWidget extends StatefulWidget {
  const ComponentMarketplaceListWidget({
    super.key,
  ...
  @override
  State<ComponentMarketplaceListWidget> createState() =>
      _ComponentMarketplaceListWidgetState();
}

class _ComponentMarketplaceListWidgetState
    extends State<ComponentMarketplaceListWidget> {
  late ComponentMarketplaceListModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ComponentMarketplaceListModel());
